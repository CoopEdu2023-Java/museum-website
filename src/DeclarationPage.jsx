...
export default function DeclarationPage({ }) {
  return (
    <div className="declaration-page">
      ...
      <img className="declaration-page-about-button" src={aboutIcon} alt="" onClick={_ => console.log("Clicked about")} />
      <img className="declaration-page-back-button" src={backIcon} alt="" onClick={_ => console.log("Clicked back")} />
      <div className="declaration-page-continue-button" onClick={_ => console.log("Clicked continue")}>继 续 观 览  &gt;</div>
    </div>
  );
}